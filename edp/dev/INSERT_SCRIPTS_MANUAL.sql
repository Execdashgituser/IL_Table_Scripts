...
(
PROGRAM_ID,"PROGRAM_NAME",PROGRAM_NOTES,PROGRAM_STATUS_SUMMARY
,INTAKE_EXECUTIVE_SUMMARY,PROJECT_ADVANTAGE,TITLE_ABBREVIATION,PROJECT_TYPE,PURPOSE_STATEMENT,PROGRAM_SIZE,
